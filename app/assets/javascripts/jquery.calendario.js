 ...
 ;( function( $, window, undefined ) {
	...
	$.Calendario.defaults = {
		...
		*/
		...
		// format is "ymd" YYYY-MM-DD, "mdy" MM-DD-YYYY
		dateFormat : "ymd",
		startIn : 0,
		...
		_initEvents : function() {
			...
			this.$el.on( 'click.calendario', 'div.fc-row > div', function() {
				...
				dateProp = {
					...
					strdate : self.year + '-' + (self.month + 1 < 10 ? '0' + ( self.month + 1 ) : self.month + 1 ) + '-' + ( $cell.children( 'span.fc-date' ).text() < 10 ? '0' + $cell.children( 'span.fc-date' ).text() : $cell.children( 'span.fc-date' ).text() )
				};
			...
			for ( var i = 0; i < 7; i++ ) {
				...
				for ( var j = 0; j <= 6; j++ ) {
					...
					if ( day <= monthLength && ( i > 0 || j >= p ) ) {
						...
						if (this.options.dateFormat == "mdy") {
